...
const renderNewTask = (id, checkBox, dateTime, desc) => {
  ...
  <div class="row mt-4">
                <div class="col-1">
                    <div class="col-12 check-box">
                        <form><input  type="checkbox" name="checkbox" value="${checkBox}"
                                id="checkbox">
                ...
                <div class="col-8">
                    <div class="row check-task p-2">
                        <div class="col-10">
                            <input type="text" placeholder="Your Task Goes Here..." value="${desc}" />
                        </div>
                        <div class="col-2 d-flex justify-content-end add-task">
                            <button id="submitTask"> Submit <i class="fas fa-save"></i>
                            </button>
                            <button id="deleteTask"> Delete <i class="fas fa-trash"></i> </button>
                        </div>
                    </div>
                </div>
